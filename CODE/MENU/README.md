...
*   **`MenuButton.js`**: Resizable arrow button (**490×105px**). Interpolates hover sliding animations, hold-down click feedback, and light glow shaders.
...
| **Settings Button** | `assets/menu_buttons/settings.png` | **980 × 210 px** *(2x detail)* | Tentacle style button (renders at 490×105px) |
| **Exit Button** | `assets/menu_buttons/exit.png` | **980 × 210 px** *(2x detail)* | Tentacle style button (renders at 490×105px) |
